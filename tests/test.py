...
pytest --mpl-generate-path=tests/baseline tests/test.py

To run the tests locally, go to the base directory of the repository and run:
pytest -rP --mpl --mpl-baseline-path=baseline --mpl-baseline-relative --mpl-generate-summary=html tests/test.py
"""
